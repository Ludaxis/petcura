    ...
    <div className="flex items-center gap-2">
      ...
      >
        <button
          ...
          className={cn(
            "inline-flex h-7 items-center gap-1.5 rounded-[5px] px-2 text-[11.5px] font-medium transition",
            view === "list"
      ...
      >
        <button
          ...
          className={cn(
            "inline-flex h-7 w-7 items-center justify-center rounded-[5px] transition",
            density === "comfortable"
