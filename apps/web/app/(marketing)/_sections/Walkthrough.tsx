...
function BeatFrame({
  ...
  return (
    <div
      className={`flex h-full flex-col gap-4 rounded-[16px] border p-6 shadow-[0_24px_48px_-32px_rgba(74,107,63,0.25)] ${accentClasses[accent]}`}
    >
      ...
      <span
        aria-hidden="true"
        className="h-[2px] w-12 rounded-full bg-[var(--primary)] opacity-60"
      />
    </div>
  );
}
