    ...
    return (
      ...
      >
        ...
        <textarea
          ...
          onKeyDown={onKeyDown}
          className={cn(
            "min-h-[56px] w-full resize-y rounded-[var(--radius-md)] border border-transparent bg-[var(--soft)] px-3 py-2 text-[13.5px] leading-[1.5] text-[var(--ink)] placeholder:text-[var(--muted-2)]",
            "focus:border-[var(--line)] focus:bg-[var(--paper)] focus:outline-none focus:ring-2 focus:ring-[var(--primary)]"
          )}
        />
        <div className="flex items-center gap-2">
          <Eyebrow tone="muted-2" aria-hidden="true">
            {labels.shortcut}
          </Eyebrow>
