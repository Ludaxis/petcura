...
export const uiCopy = {
  en: {
    ...
    "intake.submitAnother": "Send another request",
    ...
    "nav.headerTitle.calendar": "Calendar",
    ...
    "settings.status.availabilitySaved": "Availability saved.",
    ...
    "pets.noKnownAllergies": "No known allergies",
    "pets.notes": "Notes",
    ...
    "directory.openTotal": "{open} open · {total} total",
    "directory.search.loading": "Searching…",
    "consent.ariaLabel": "Cookie notice",
    "consent.heading": "Privacy-first analytics",
    "consent.body":
      "PetCura uses essential cookies to run the service. Optional analytics helps us improve clinic workflows and never includes owner messages or medical details.",
  ...
  et: {
    ...
    "intake.submitAnother": "Saada veel üks pöördumine",
    ...
    "request.kbd.send": "Fookus vastusele",
    ...
    "nav.headerTitle.calendar": "Kalender",
    ...
    "settings.status.availabilitySaved": "Saadavus salvestatud.",
    ...
    "settings.tabs.availability": "Saadavus",
    ...
    "pets.noKnownAllergies": "Teadaolevad allergiad puuduvad",
    "pets.notes": "Märkmed",
    ...
    "directory.openTotal": "{open} avatud · {total} kokku",
    "directory.search.loading": "Otsin…",
    "consent.ariaLabel": "Küpsiste teade",
    "consent.heading": "Privaatsust austav analüütika",
    "consent.body":
      "PetCura kasutab teenuse toimimiseks vajalikke küpsiseid. Vabatahtlik analüütika aitab meil kliiniku töövoogu parandada ega sisalda kunagi omanike sõnumeid ega meditsiinilisi andmeid.",
  ...
  ru: {
    ...
    "intake.submitAnother": "Отправить ещё один запрос",
    ...
    "request.kbd.send": "Перейти к ответу",
    ...
    "nav.headerTitle.calendar": "Календарь",
    ...
    "settings.status.availabilitySaved": "Доступность сохранена.",
    ...
    "settings.tabs.availability": "Доступность",
    ...
    "pets.noKnownAllergies": "Известных аллергий нет",
    "pets.notes": "Заметки",
    ...
    "directory.action.call": "Позвонить",
    ...
    "directory.openTotal": "{open} открытых · {total} всего",
    "directory.search.loading": "Идёт поиск…",
    "consent.ariaLabel": "Уведомление о cookie",
    "consent.heading": "Аналитика без ущерба для приватности",
    "consent.body":
      "PetCura использует необходимые cookie для работы сервиса. Опциональная аналитика помогает улучшать клинические процессы и никогда не включает сообщения владельцев или медицинские данные.",
